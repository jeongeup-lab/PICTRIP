...
플랫 디렉토리 + 안정 ID(`S00`~`S12`) 구조. **파일 정렬 순서 = 읽는 순서**이며,
...
| S02 | [`S02-home-curation.md`](S02-home-curation.md) | 홈 피드 + 큐레이션 상세 | 05·06 |
| S03 | [`S03-spot-detail.md`](S03-spot-detail.md) | 스팟 상세 | 07 |
| S04 | [`S04-photo-search.md`](S04-photo-search.md) | 사진 검색 플로우 | 08–10 |
