...
CASES: list[Case] = [
    ...
    plan("Q1", "박수로 준 일수", "통영 1박2일 일정 짜줘", expect_text=("통영",)),
    plan("Q2", "코스라고 불러도", "부산 2박3일 코스 만들어줘", expect_text=("부산",)),
    plan("Q3", "맛집을 끼운 일정", "경주 2일 일정인데 맛집도 넣어줘", expect_text=("경주",)),
    plan("Q4", "일수 없이", "여수 여행 일정 짜줘", expect_text=("여수",)),
    case(
        "Q5",
        "N 일정",
        "일정에 못 넣는 종류",
